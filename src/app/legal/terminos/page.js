    ...
    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "3rem", alignItems: "start" }}>
      ...
      <main>
        ...
        <LegalSection index={2} id="requisitos" title="Requisitos de Participación">
          <p>Para participar en los sorteos, es requisito indispensable ser persona natural mayor de 18 años de edad al momento de la adquisición del boleto[cite: 97]. SorteosVIP se reserva el derecho de solicitar la verificación de la mayoría de edad mediante documento de identidad oficial[cite: 115].</p>
        ...
        <LegalSection index={4} id="sorteo" title="Realización del Sorteo">
          <p>Los sorteos se llevarán a cabo rigurosamente en la fecha, hora y lugar publicados previamente en la ficha técnica de cada premio dentro de la plataforma[cite: 107]. SorteosVIP se reserva la facultad de realizar transmisiones en vivo del proceso a través de sus canales oficiales de redes sociales para garantizar la transparencia[cite: 108].</p>
        ...
        <LegalSection index={5} id="premios" title="Entrega de Premios">
          <p>Tras la finalización del sorteo, el ganador será notificado oficialmente por SorteosVIP en un plazo máximo de 48 horas a través del correo electrónico o número telefónico proporcionado en su registro[cite: 112]. El ganador dispondrá de un plazo máximo de 30 días calendario para reclamar su premio[cite: 113].</p>
